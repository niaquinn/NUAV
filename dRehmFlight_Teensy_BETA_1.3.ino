...
#include <PWMServo.h> //Commanding any extra actuators, installed with teensyduino installer
  ...
  #include "src/SBUS/SBUS_caps.h"   //sBus interface
  #include "src/SBUS/SBUS_caps.cpp"
#endif
...
const int ch6Pin = 19; //aux1 (free aux channel)
...
void setup() {
  Serial.begin(100000); //USB serial
  delay(500);
